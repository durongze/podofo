...
%comspec% /k "E:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\VC\Auxiliary\Build\vcvars32.bat"
...
pushd dyzbuild
	...
	@rem cmake --build . -j16
	cmake ..
	cmake --build . --target examples\helloworld\helloworld  -j16
	@rem cmake --build .
